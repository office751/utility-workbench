  ...
  runs: [
    {
      ...
      items: [
        ...
        s('ind-k-sb5', 'cab', 'B36', 36, 'end stacks with upper at 138"; finished end panel — 4" of wall to the slider'),
      ],
    },
    {
      id: 'ind-k-rangebase',
    ...
    },
    {
      ...
      items: [
        ...
        s('ind-k-su5', 'cab', 'W3342', 33, 'end stacks over base B36; finished end panel — 4" of wall to the slider'),
      ],
    },
    {
      id: 'ind-k-rangeupper',
