 ...
 *
 * Carey-readiness #5: every outbound draft (SECO/Duke apply, meter-notify,
 * vendor orders) used to fire the moment you clicked — no preview, no second
 * pair of eyes. This restates the load-bearing facts and returns true ONLY
